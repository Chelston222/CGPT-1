...
from src.chat_memory import candidate_stats, chat_search, ingest_events, ingest_export, list_candidates
...
class ChatMemoryV3Tests(unittest.TestCase):
    ...
    def test_incremental_ingest_is_idempotent(self):
        ...
        self.assertEqual(second["messages_changed"], 0)
        hits = chat_search(self.conn, "concise English", 5)
        self.assertEqual(hits[0]["message_id"], "live-m1")
