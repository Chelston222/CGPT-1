...
ALLOWED = {
    "DISCOVERED": {"SCORED", "REJECTED", "SUPPRESSED"},
    "SCORED": {"PROPOSAL_READY", "NEEDS_HUMAN_FACT", "REJECTED", "SUPPRESSED"},
    "PROPOSAL_READY": {"READY_TO_SUBMIT", "NEEDS_HUMAN_FACT", "REJECTED", "SUPPRESSED"},
    "NEEDS_HUMAN_FACT": {"PROPOSAL_READY", "READY_TO_SUBMIT", "REJECTED", "SUPPRESSED"},
    "READY_TO_SUBMIT": {"SUBMITTED", "REJECTED", "SUPPRESSED"},
